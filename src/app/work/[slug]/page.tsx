    ...
    <PageShell>
      <section className="relative overflow-hidden pt-36 pb-12 sm:pt-44">
        ...
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          <Reveal>
            ...
            <p className="mt-5 inline-flex rounded-full border border-line bg-white/[0.05] px-3 py-1.5 text-xs text-mist-faint">
      ...
      <section className="px-5 pb-16 sm:px-8">
        <div className="mx-auto max-w-3xl space-y-10">
          ...
          <Reveal>
            <div className="rounded-2xl border border-line bg-white/[0.04] p-7">
