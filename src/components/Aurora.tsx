 ...
 *  bright page feel alive and premium (olive-drab / khaki / field-olive tones). */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(150,130,60,0.20), transparent 65%)", animationDelay: "5s" }}
      />
      <div
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(110,122,58,0.16), transparent 65%)", animationDelay: "13s" }}
      />
    </div>
  );
}
